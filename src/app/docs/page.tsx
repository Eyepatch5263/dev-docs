    ...
    <div className="min-h-screen bg-background">
      <div className="min-h-[calc(100vh-3.5rem)] flex flex-col">
        ...
        <section className="flex-1 flex flex-col items-center justify-center px-6 py-16 mx-auto text-center">
          ...
          <HeroReusableComponent
            title="Developer's"
            subHeading="Documentation Doom"
            description="Deep-dive into system fundamentals with richly illustrated guides. Master databases, operating systems, and distributed architectures through diagrams, examples, and visual breakdowns."
          />
        ...
        <footer className="border-t border-border py-6 px-6 text-center text-sm text-muted-foreground">
          <p>
            Built By Developer for Developers. &copy; {new Date().getFullYear()}{" "}
            EyePatch5263.
          </p>
        </footer>
      </div>
