    ...
    <main className="container mx-auto px-4 py-12">
      ...
      >
        <HeroReusableComponent
          title="Master"
          subHeading="Technical Concepts"
          description="Transform complex technical concepts into bite-sized flashcards. Learn faster, retain longer, and ace your interviews with confidence."
        />
        {/* Stats */}
