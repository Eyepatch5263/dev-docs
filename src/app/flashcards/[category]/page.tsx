...
export async function generateMetadata({ params }: CategoryPageProps) {
    ...
    return {
        title: categoryInfo ? `${categoryInfo.name} Flashcards | Explainbytes` : "Flashcards | Explainbytes",
        description: categoryInfo?.description || "Master computer science and system design concepts with interactive flashcards.",
    };
}
