...
import { FlashcardCategory, CategoryInfo, Flashcard as FlashcardType } from '@/app/types/flashcard.type';
...
export function CategoryClient({ category, categoryInfo, initialCards }: CategoryClientProps) {
