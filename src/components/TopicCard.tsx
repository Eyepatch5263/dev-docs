...
export function TopicCard({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`group relative p-6 rounded-2xl border-2 transition-all duration-300 cursor-pointer overflow-hidden h-full bg-muted/30 ${
            isAvailable ? "hover:scale-105 hover:shadow-xl" : "opacity-60"
          }`}
          style={{
