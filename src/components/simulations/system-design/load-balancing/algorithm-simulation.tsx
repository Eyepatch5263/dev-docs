    ...
    <div className="w-full my-8 p-6 rounded-2xl border border-zinc-800/80 bg-zinc-950/85 backdrop-blur-md shadow-2xl flex flex-col gap-6 select-none text-zinc-100">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between border-b border-zinc-800/60 pb-4 gap-4">
        ...
        <button
          ...
          className="px-3 py-1.5 rounded-lg bg-zinc-900 border border-zinc-800 hover:bg-zinc-850 hover:border-zinc-700 text-zinc-200 transition-all flex items-center gap-1.5 text-xs font-bold cursor-pointer"
        >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2 bg-zinc-900/60 p-1 rounded-xl border border-zinc-850">
        {(
          [
            "round_robin",
            "weighted_round_robin",
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 flex flex-col gap-4">
          <div className="relative h-[600px] w-full rounded-xl border border-zinc-800 bg-black/60 overflow-hidden">
              ...
              return (
                <div
                  ...
                  className={`absolute left-[12%] -translate-x-1/2 -translate-y-1/2 w-[120px] p-2.5 rounded-xl border transition-all text-center cursor-pointer ${
                    isActive
                      ? "bg-zinc-900 border-zinc-200 shadow-md scale-105"
                      : "bg-zinc-950/90 border-zinc-850 hover:border-zinc-700"
                  }`}
                >
                  <div className="flex items-center gap-1.5 justify-center border-b border-zinc-800 pb-1 mb-1">
                    <User
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[130px] p-3 rounded-xl border border-zinc-800 bg-zinc-900 shadow-xl text-center">
              <div className="flex items-center gap-1.5 justify-center border-b border-zinc-800 pb-1.5 mb-1.5">
                <span className="text-[10px] font-extrabold tracking-wider text-zinc-400 uppercase">
                  Load Balancer
                </span>
              </div>
              <div className="text-[9px] bg-zinc-900 text-white font-bold px-1.5 py-0.5 rounded inline-block font-mono border border-white">
            ...
            {servers.map((s, idx) => {
              ...
              return (
                <div
                  key={s.id}
                  style={{ top: yPos }}
                  className={`absolute right-[12%] translate-x-1/2 -translate-y-1/2 w-[140px] p-2.5 rounded-xl border bg-zinc-950/90 shadow-lg text-left transition-colors border-zinc-850 ${
                ...
                >
                  <div className="flex items-center justify-between border-b border-zinc-800 pb-1 mb-1">
                    ...
                    <span className="text-[7.5px] bg-zinc-800 text-zinc-400 px-1 rounded font-bold font-mono">
                      Wt: {s.weight}
                    </span>
                  </div>
                  ...
                  <div className="space-y-0.5 text-[8.5px]">
                    ...
                    <div className="flex justify-between text-zinc-500">
                      <span>CPU:</span>
                      <span className="text-zinc-400 font-mono">{s.cpu}%</span>
                    </div>
                  </div>
                </div>
              );
          ...
          {/* Trigger Panel */}
          <div className="bg-zinc-900/30 border border-zinc-800/80 p-4 rounded-xl flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
            <div className="flex-1 space-y-2">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 py-2 px-3 rounded-xl bg-purple-655 hover:bg-purple-600 font-bold text-xs text-white transition-colors flex items-center justify-center gap-1.5 cursor-pointer shadow-lg shadow-purple-900/20"
                >
                  Send Request
                </button>
                <button
                  ...
                  className="flex-1 py-2 px-3 rounded-xl bg-zinc-900 border border-zinc-850 hover:bg-zinc-800 hover:border-zinc-700 font-bold text-xs text-zinc-200 transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
                >
                  Send Burst (5x)
                </button>
                <button
            ...
            <div className="h-px sm:h-12 w-full sm:w-px bg-zinc-850" />
                  ...
                  <button
                    ...
                    className={`flex-1 py-2 rounded-xl text-[9px] font-bold transition-all border cursor-pointer ${
                      s.isSlow
                        ...
                        : "bg-zinc-950 text-zinc-400 border-zinc-850 hover:text-zinc-300"
                    }`}
                  >
          ...
          <div className="space-y-2 pb-3 border-b border-zinc-800">
            ...
            <div className="grid grid-cols-1 gap-1 text-[10.5px] pt-1">
              <div>
                ...
                <span className="text-zinc-300">{activeAlgoDesc.pros}</span>
              </div>
              <div className="mt-1">
                <span className="font-bold text-red-400 block uppercase tracking-wider text-[8px] mb-0.5">Cons</span>
                <span className="text-zinc-300">{activeAlgoDesc.cons}</span>
              </div>
            </div>
          </div>

          {/* Code Snippet Window */}
          <div className="flex-1 flex flex-col bg-zinc-950 rounded-xl border border-zinc-850 overflow-hidden min-h-[300px]">
