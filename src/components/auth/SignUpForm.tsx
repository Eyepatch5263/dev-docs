    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-2">
          <Label htmlFor="name" className="text-sm ml-1 lg:text-base">
            Full Name
          </Label>
        ...
        {/* Email Field */}
        <div className="space-y-2">
          <Label htmlFor="email" className="text-sm ml-1 lg:text-base">
            Email
          </Label>
          <div className="relative mt-2">
        ...
        {/* Password Field */}
        <div className="space-y-2">
          <Label htmlFor="password" className="text-sm ml-1 lg:text-base">
            Password
          </Label>
          <div className="relative mt-2">
        ...
        <div className="space-y-2">
          <Label
            ...
            className="text-sm ml-1 lg:text-base"
          >
            Confirm Password
          </Label>
          <div className="relative mt-2">
