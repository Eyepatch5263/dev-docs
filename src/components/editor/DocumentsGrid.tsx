...
export function DocumentsGrid({ initialDocuments }: DocumentsGridProps) {
  ...
  return (
    <div>
      ...
      {docSize == MAX_DOCUMENTS && (
        <div className="h-full cursor-not-allowed mt-5 min-h-[180px] p-6 rounded-xl border-2 border-dashed border-red-500/80 flex flex-col items-center justify-center gap-3 transition-all duration-200 group">
