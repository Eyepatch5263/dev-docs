...
export default function SubmissionCard({
  ...
  const initials = generateAvatarInitials(
    document.owner.name,
    document.owner.email,
  );
  const avatarColor = generateAvatarColor(document.owner.email);
  const profileImage = document.owner.avatar_url
      ...
      <AlertDialog open={showApproveDialog} onOpenChange={setShowApproveDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will approve "{document.description || "Untitled Document"}"
              and make it visible to all users. This action can be reversed
              later if needed.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <AlertDialog open={showRejectDialog} onOpenChange={setShowRejectDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will reject "{document.description || "Untitled Document"}".
              The submitter will be notified. This action can be reversed later
              if needed.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
